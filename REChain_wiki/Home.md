...
- [Testing & CI/CD](Aurora-CI-CD.md)
- [Security Best Practices](Security-Best-Practices.md)
- [Code Samples](Code-Samples.md)

### For End Users
- [Getting Started](../docs/end_user/GETTING_STARTED.md)
...
### How-tos & Deep Dives
- [How to Set Up REChain](How-to-Set-Up-REChain.md)
- [How to Use End-to-End Encryption](How-to-use-end-to-end-encryption-in-REChain.md)
- [Quick Account Switching](Quick-account-switching-in-REChain.md)
...
- [Translators Guide](Translators-Guide.md)
- [Release Process](Publish-a-new-Release.md)
- [Community Matrix Room](https://matrix.to/#/#chatting:matrix.katya.wtf)

---

For the full documentation, see the [docs/](../docs/) directory and [README.md](../README.md).
