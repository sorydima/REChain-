...
sudo urpmi --auto rechainonline-4.1.10-1.x86_64.rpm
```
...
sudo rpm -i --force --nodeps rechainonline-4.1.10-1.x86_64.rpm
...
# 2. Выбрать rechainonline-4.1.10-1.x86_64.rpm
# 3. Нажать "Установить"
```
...
*Руководство для ROSA Linux версии 4.1.10+1160*
