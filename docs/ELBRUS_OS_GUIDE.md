...
wget https://github.com/sorydima/REChain-/releases/latest/download/rechainonline-4.1.7-1.e2k.rpm

# Установка
sudo rpm -i rechainonline-4.1.7-1.e2k.rpm

# Или через yum/dnf
sudo yum install rechainonline-4.1.7-1.e2k.rpm
```
...
*Руководство для ОС «Эльбрус» версии 4.1.7+1150*
