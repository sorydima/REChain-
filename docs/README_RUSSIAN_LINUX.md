...
# Структура пакетов
packages/
├── rechainonline-4.1.7-amd64.deb          # DEB пакет (48.4 МБ)
├── rpm/
│   ├── RPMS/x86_64/
│   │   └── rechainonline-4.1.7-1.x86_64.rpm  # RPM пакет (50.3 МБ)
│   └── SRPMS/
│       └── rechainonline-4.1.7-1.src.rpm     # Исходный RPM (56.7 МБ)
└── appimage/
...
*Версия документации: 4.1.7+1150*  
