...
class L10nSr extends L10n {
  ...
  String inviteText(String username, String link) {
    return '$username вас позива у rechain. \n1. Инсталирајте rechain: https://https://online.rechain.network \n2. Региструјте се или пријавите \n3. Отворите везу позивнице: $link';
  }
  ...
  @override
  String get newMessageInrechainonline => 'Нова порука — rechain';
  ...
  String get noGoogleServicesWarning =>
      'Чини се да немате Гугл услуге на телефону. То је добра одлука за вашу приватност! Да би се протурале нотификације у rechain, препоручујемо коришћење https://microg.org/ или https://unifiedpush.org/';
