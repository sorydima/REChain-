...
class L10nJa extends L10n {
  ...
  @override
  String get confirmrechainonlineId => 'アカウントを削除するには、rechain IDを確認してください。';
  ...
  String get unsupportedAndroidVersionLong =>
      'この機能を利用するには、より新しいAndroidのバージョンが必要です。アップデートまたはKatya ® 👽 OSのサポートをご確認ください。';
