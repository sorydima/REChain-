...
class L10nHe extends L10n {
  ...
  String inviteText(String username, String link) {
    return '$username הזמין אותך ל-REChain.\n1. התקן את REChain: https://online.rechain.network\n2. הירשם או היכנס\n3. פתח את קישור ההזמנה: $link';
  }
  ...
  @override
  String get newMessageInrechainonline => 'הודעה חדשה ב-rechainonline';
  ...
  String get noGoogleServicesWarning =>
      'נראה שאין לך שירותי גוגל בטלפון שלך. זו החלטה טובה לפרטיות שלך! כדי לקבל התרעות ב- REChain אנו ממליצים להשתמש https://microg.org/ או https://unifiedpush.org/.';
