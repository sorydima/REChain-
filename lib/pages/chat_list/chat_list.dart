...
class ChatListController extends State<ChatList>
  ...
  void onChatTap(Room room) async {
    ...
    if (shareContent != null) {
      ...
      if (shareContent.tryGet<String>('msgtype') == 'com.rechainonline.shared_file' &&
          shareFile != null) {
        await showDialog(
          context: context,
  ...
  static const String _serverStoreNamespace = 'im.rechainonline.search.server';
  ...
  void _processIncomingSharedFiles(List<SharedMediaFile> files) {
    ...
    Matrix.of(context).shareContent = {
      'msgtype': 'com.rechainonline.shared_file',
      'file': MatrixFile(
