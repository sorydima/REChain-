...
class RunnerTests: XCTestCase {
    ...
    func testCheckFileAccessPermission() throws {
        let hasPermission = permissionManager.checkFileAccessPermission()
        XCTAssertTrue(hasPermission == true || hasPermission == false)
    }
    ...
    func testCheckAllRequiredPermissions() throws {
        ...
        XCTAssertTrue(permissions.keys.contains("fileAccess"))
    }
    ...
    func testDeviceInfo() throws {
        ...
        XCTAssertEqual(deviceInfo.systemName, "macOS")
